...
const UIManager = {
    ...
    renderAnalysisBubbles() {
        ...
        // Pozisyon hesaplama - SADECE PC'DE
        const positions = window.innerWidth > 768 ? UIManager.calculateBubblePositions(countriesData, maxValue) : [];
        ...
        countriesData.forEach((country, index) => {
            ...
            // Mobilde CSS Flexbox kullanılacak (position: static)
