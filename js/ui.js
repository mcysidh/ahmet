...
const UIManager = {
    ...
    renderAnalysisBubbles() {
        ...
        // CSS Grid kullanıyoruz - pozisyon hesaplamaya gerek yok
        // Balonları oluştur ve render et
        countriesData.forEach((country, index) => {
            const bubbleWrapper = document.createElement('div');
            // CSS'te zaten tanımlı, inline style ekleme
            ...
            // Boyutları direkt ata - CSS override etmiyor artık
            ...
            // CSS Grid kullanıyoruz - absolute positioning yok
            // Grid otomatik olarak sıralı düzen sağlayacak
